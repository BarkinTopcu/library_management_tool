...
class Ui_Widget(object):
    def setupUi(self, Widget):
        ...
        icon = QIcon()
        icon.addFile(u"images/homepage.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon1 = QIcon()
        icon1.addFile(u"images/books.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.books_menu_button.setIcon(icon1)
        ...
        icon2 = QIcon()
        icon2.addFile(u"images/loan.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.loans_menu_button.setIcon(icon2)

        self.verticalLayout.addWidget(self.loans_menu_button)

        self.staff_button = QPushButton(self.menu_widget)
        self.staff_button.setObjectName(u"staff_button")
        icon3 = QIcon()
        icon3.addFile(u"images/membership-card.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.staff_button.setIcon(icon3)
        ...
        self.staff_menu_widget = QWidget()
        self.staff_menu_widget.setObjectName(u"staff_menu_widget")
        self.verticalLayout_8 = QVBoxLayout(self.staff_menu_widget)
        self.verticalLayout_8.setObjectName(u"verticalLayout_8")
        self.frame_2 = QFrame(self.staff_menu_widget)
        self.frame_2.setObjectName(u"frame_2")
        self.frame_2.setMinimumSize(QSize(685, 0))
        ...
        self.groupBox_5.setStyleSheet(u"background:white;")
        self.label_3 = QLabel(self.groupBox_5)
        self.label_3.setObjectName(u"label_3")
        self.label_3.setGeometry(QRect(40, 35, 49, 16))
        self.staff_loan_ID = QLineEdit(self.groupBox_5)
        self.staff_loan_ID.setObjectName(u"staff_loan_ID")
        self.staff_loan_ID.setGeometry(QRect(90, 30, 113, 22))
        self.loan_edit_button = QPushButton(self.groupBox_5)
        self.loan_edit_button.setObjectName(u"loan_edit_button")
        self.loan_edit_button.setGeometry(QRect(210, 40, 75, 24))
        self.label_5 = QLabel(self.groupBox_5)
        self.label_5.setObjectName(u"label_5")
        self.label_5.setGeometry(QRect(40, 60, 49, 16))
        self.staff_loan_status = QLineEdit(self.groupBox_5)
        self.staff_loan_status.setObjectName(u"staff_loan_status")
        self.staff_loan_status.setGeometry(QRect(90, 60, 113, 22))
        ...
        self.groupBox_4.setStyleSheet(u"background:white;")
        self.show_staff_loans = QPushButton(self.groupBox_4)
        self.show_staff_loans.setObjectName(u"show_staff_loans")
        self.show_staff_loans.setGeometry(QRect(40, 40, 121, 24))

        self.horizontalLayout_5.addWidget(self.groupBox_4)


        self.verticalLayout_8.addWidget(self.frame_2, 0, Qt.AlignLeft)

        self.widget_4 = QWidget(self.staff_menu_widget)
        self.widget_4.setObjectName(u"widget_4")
        self.staff_loan_table = QTableWidget(self.widget_4)
        self.staff_loan_table.setObjectName(u"staff_loan_table")
        self.staff_loan_table.setGeometry(QRect(0, 0, 691, 521))
        self.staff_loan_table.setStyleSheet(u"background:white;")

        self.verticalLayout_8.addWidget(self.widget_4)

        self.main_widget.addWidget(self.staff_menu_widget)
...
"")
        ...
        self.label_8.setPixmap(QPixmap(u"images/user.png"))
        ...
        self.label_17 = QLabel(self.main_menu_log_in)
        self.label_17.setObjectName(u"label_17")
        self.label_17.setGeometry(QRect(50, 210, 41, 41))
        self.label_17.setStyleSheet(u"")
        self.label_17.setPixmap(QPixmap(u"images/password.png"))
...
"")
        ...
        self.search_button_books.setGeometry(QRect(580, 10, 75, 24))
    ...
    def retranslateUi(self, Widget):
        ...
        self.staff_button.setText(QCoreApplication.translate("Widget", u"Staff", None))
        ...
        self.groupBox_5.setTitle(QCoreApplication.translate("Widget", u"Loan Edit", None))
        self.label_3.setText(QCoreApplication.translate("Widget", u"Loan ID:", None))
        self.loan_edit_button.setText(QCoreApplication.translate("Widget", u"Edit", None))
        self.label_5.setText(QCoreApplication.translate("Widget", u"Status:", None))
        self.groupBox_4.setTitle(QCoreApplication.translate("Widget", u"Loans", None))
        self.show_staff_loans.setText(QCoreApplication.translate("Widget", u"Show All Loans", None))
